...
<figure>
  <img src="/assets/img/ramblings/claude-code-context-bar.png" width="2064" height="456" loading="lazy" decoding="async" alt="Claude Code status line showing a context usage progress bar." />
